    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: 'instalaciones',
            loadChildren: '../instalaciones/listing/instalaciones-listing.module#InstalacionesListingPageModule'
          },
          {
            path: 'nueva-instalacion',
            loadChildren: '../nueva-instalacion/nueva-instalacion.module#NuevaInstalacionPageModule'
          },
          {
            path: 'instalaciones/:productId',
            loadChildren: '../instalaciones/details/instalaciones-details.module#InstalacionesDetailsPageModule'
          },
          {
            path: 'deals',
