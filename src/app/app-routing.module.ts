...
const routes: Routes = [
  ...
  //{ path: 'nueva-instalacion', loadChildren: './pages/nueva-instalacion/nueva-instalacion.module#NuevaInstalacionPageModule' },
  //{ path: 'memoria-detalle', loadChildren: './pages/memoria-detalle/memoria-detalle.module#MemoriaDetallePageModule' },
